...
final as (
  ...
  left join address as staff_address on staff.address_id = staff_address.address_id
  left join store on staff.store_id = store.store_id
  left join address as store_address on store.address_id = store_address.address_id
